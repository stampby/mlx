...
__global__ void set_mm_device_pointers_nd(
    ...
    int8_t* out_start,
    int item_size,
    const __grid_constant__ hip::std::array<int32_t, NDIM> batch_shape,
    const __grid_constant__ hip::std::array<int64_t, NDIM> a_batch_strides,
    const __grid_constant__ hip::std::array<int64_t, NDIM> b_batch_strides,
...
__global__ void set_addmm_device_pointers_nd(
    ...
    const __grid_constant__ hip::std::array<int64_t, NDIM> a_batch_strides,
    const __grid_constant__ hip::std::array<int64_t, NDIM> b_batch_strides,
    const __grid_constant__ hip::std::array<int64_t, NDIM> c_batch_strides,
    int64_t batch_stride,
    int batch_count) {
  auto index = cg::this_grid().thread_rank();
  if (index >= batch_count) {
...
void set_pointer_mode(hipblasLtMatrixLayout_t desc, int batch_count) {
  ...
  CHECK_HIPBLAS_ERROR(hipblasLtMatrixLayoutSetAttribute(
      ...
      sizeof(batch_mode)));
  CHECK_HIPBLAS_ERROR(hipblasLtMatrixLayoutSetAttribute(
      desc, HIPBLASLT_MATRIX_LAYOUT_BATCH_COUNT, &batch_count, sizeof(int32_t)));
}
