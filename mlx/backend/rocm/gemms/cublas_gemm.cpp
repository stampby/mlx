...
hipblasComputeType_t dtype_to_compute_type(Dtype dtype) {
  switch (dtype) {
    case float16:
    ...
    case bfloat16:
      return HIPBLAS_COMPUTE_32F;
    case float32:
      return mlx::core::env::enable_tf32() ? HIPBLAS_COMPUTE_32F_FAST_TF32
                                           : HIPBLAS_COMPUTE_32F;
    case float64:
...
CublasGemm::CublasGemm(
  ...
  if (dtype == bfloat16 || dtype == float16) {
    scale_type_ = HIP_R_32F;
  }
  hipDataType cublas_dtype =
