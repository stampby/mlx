...
class CudaAllocator : public allocator::Allocator {
 public:
  ...
  void move_to_unified_memory(CudaBuffer& buf, hipStream_t stream = nullptr);
 ...
 private:
  void free_hip_buffer(CudaBuffer* buf);
  void free_async(CudaBuffer& buf, hipStream_t stream = nullptr);
  ...
  std::vector<hipMemPool_t> mem_pools_;
